...
<body>
	...
	if(arr.size()>0){
		for(int i = 0; i < arr.size(); i++) {
			...
			out.print("<td class='shoping__cart__price' style='width:200px; text-align:center; font-size:15px;'><a id='buttstyle' class='snip1535two href='reviewwrite.jsp?goodsseq="+arr.get(i).getSeq()+"'>리뷰등록</a></td>");		
			out.print("</tr>");
		}
	}else{
