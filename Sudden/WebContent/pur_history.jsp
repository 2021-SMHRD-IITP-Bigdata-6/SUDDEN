    	...
    	for(int i = 0; i<tarr.size(); i++){
    		...
    		if(garr.size()>0){
    			for(int j = 0; j < garr.size(); j++) {
    				...
    				if(rating>0){
    					out.print("<td class='shoping__cart__price' style='width:200px; text-align:center; font-size:15px;'>리뷰등록완료</td>");		
    				}
    				else{
    					out.print("<td class='shoping__cart__price' style='width:200px; text-align:center; font-size:15px;'><a class='snip1535' href='reviewwrite.jsp?goodsseq="+garr.get(j).getSeq()+"'>리뷰등록</a></td>");		
    				}
